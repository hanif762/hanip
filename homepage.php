...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top">
    <div class="container">
      <a class="navbar-brand" href="#">GOAT PLAYER</a>
      <button
...
<section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
    <div class="container">
      <div class="d-sm-flex flex-sm-row-reverse align-items-center">
        <img src="https://akcdn.detik.net.id/community/media/visual/2024/11/06/cristiano-ronaldo-1_169.jpeg?w=600&q=90" class="img-fluid" width="300" />
        <div>
          <h1 class="fw-bold display-4">
            The Great of the history player 
          </h1>
          <h4 class="lead display-6">
            Cristian Ronaldo The GOAT
          </h4>
          <h6>
...
<!-- article end -->
    ...
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-center">
        ...
        <div class="p-md-5 text-sm-start">
          <h3 class="lead">A11.2023.15313
          </h3>
          <h1 class="fw-bold">Muhammad Hanif</h1>
 ...
 <footer id="footer" class="text-center p-5">
  ...
  <div>Muhammad Hanif&copy; 2024</div>
</footer>
<!-- footer end -->
